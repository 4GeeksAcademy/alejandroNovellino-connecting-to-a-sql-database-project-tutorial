...
print('\nPublisher table:')
print(pd.read_sql("SELECT * FROM publishers;", engine))

print('\nAuthors table:')
print(pd.read_sql("SELECT * FROM authors;", engine))

print('\nBooks table:')
print(pd.read_sql("SELECT * FROM books;", engine))

print('\nBook_authors table:')
print(pd.read_sql("SELECT * FROM book_authors;", engine))

print('\nBook_authors table with join:')
print(pd.read_sql("SELECT title, first_name as author_name, last_name as author_last_name FROM book_authors, books, authors WHERE books.book_id = book_authors.book_id and authors.author_id = book_authors.author_id;", engine))